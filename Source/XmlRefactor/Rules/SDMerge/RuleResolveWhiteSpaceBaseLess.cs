...
{
    class RuleResolveWhiteSpaceBaseLess : Rule
    {
        public override string RuleName()
        {
            return "Resolve WhiteSpace baseless";
        }
...
//                    continue;
        ...
        public string Run(string input, int startAt = 0)
        {
            ...
            if (match.Success)
            {
                ...
                string theirs = split[1];
                string yours = split[3];
